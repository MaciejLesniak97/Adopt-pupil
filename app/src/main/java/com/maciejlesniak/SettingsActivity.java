...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //!!!!! DO ZMIANY POTRZEBUJE CHILD USERSEX PRZED USERID -SPRAWDZIĆ-
        ...
        mUserDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists() && snapshot.getChildrenCount()>0) {
                    ...
                    if(map.get("nazwa") != null) {
                        name = map.get("nazwa").toString();
                        mNameField.setText(name);
                    }
                    if(map.get("telefon") != null) {
                        phone = map.get("telefon").toString();
                        mPhoneField.setText(phone);
                    }
                    if (map.get("rodzaj użytkownika") != null) {
                        userSex = map.get("rodzaj użytkownika").toString();
                    }
    ...
    private void saveUserInformation() {
        ...
        userInfo.put("telefon", phone);
        userInfo.put("opis", description);
